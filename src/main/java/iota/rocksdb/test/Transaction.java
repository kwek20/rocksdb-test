...
import iota.rocksdb.test.util.Serializer;
import iota.rocksdb.test.util.TransactionTruncator;
...
public class Transaction implements Persistable {
    ...
    public void readMetadata(byte[] bytes) {
        ...
        int i = 0;
        address = HashFactory.TRANSACTION.create(bytes, i, Hash.SIZE_IN_BYTES);
        i += Hash.SIZE_IN_BYTES;
        bundle = HashFactory.TRANSACTION.create(bytes, i, Hash.SIZE_IN_BYTES);
        i += Hash.SIZE_IN_BYTES;
        ...
        i += Hash.SIZE_IN_BYTES;
        obsoleteTag = HashFactory.TRANSACTION.create(bytes, i, Hash.SIZE_IN_BYTES);
        i += Hash.SIZE_IN_BYTES;
        ...
        tag = HashFactory.TRANSACTION.create(bytes, i, Hash.SIZE_IN_BYTES);
        i += Hash.SIZE_IN_BYTES;
    ...
    public String toString() {
        return "Transaction [address=" + address + ", bundle=" + bundle
                + ", trunk=" + trunk + ", branch=" + branch + ", obsoleteTag=" + obsoleteTag + ", value=" + value
                + ", currentIndex=" + currentIndex + ", lastIndex=" + lastIndex + ", timestamp=" + timestamp + ", tag="
                + tag + ", attachmentTimestamp=" + attachmentTimestamp + ", attachmentTimestampLowerBound="
                + attachmentTimestampLowerBound + ", attachmentTimestampUpperBound=" + attachmentTimestampUpperBound
                + ", validity=" + validity + ", type=" + type + ", arrivalTime=" + arrivalTime + ", parsed=" + parsed
                + ", solid=" + solid + ", milestone=" + milestone + ", height=" + height
                + ", snapshot=" + snapshot + "]";
    }
}
